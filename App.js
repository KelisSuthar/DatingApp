...
import MatchedPopup from './src/Screens/MatchedPopup';
import Chatting from './src/Screens/Chatting';
import ViewPofile from './src/Screens/VIewProfile';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName={stringAssets.Splash}>
        <Stack.Screen
          name={stringAssets.Splash}
          component={Splash}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.WalkThrough}
          component={WalkThrough}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.Login}
          component={Login}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.Login_2}
          component={Login2}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.Forgot_Pass}
          component={ForgtePass}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.Home}
          component={Home}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.Settings}
          component={Setting}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.CardList}
          component={CardLists}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.AddCard}
          component={AddCard}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.ProfileInfo}
          component={ProfileInfo}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.Membership}
          component={Membership}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.MatchedPopup}
          component={MatchedPopup}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.Chatting}
          component={Chatting}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.view_profile}
          component={ViewPofile}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name={stringAssets.JitsiView}
          component={JistiView}
          options={{headerShown: false}}
        />
